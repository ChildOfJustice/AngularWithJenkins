...
class AppComponent {
    constructor() {
        this.title = 'Angular Unit Testing';
    }
}
...
ProductAlertsComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: ProductAlertsComponent, selectors: [["app-product-alerts"]], inputs: { product: "product", something: "something" }, outputs: { notify: "notify" }, decls: 1, vars: 1, consts: [[4, "ngIf"], [3, "click"]], template: function ProductAlertsComponent_Template(rf, ctx) { if (rf & 1) {
...
/* harmony import */ var _product_alerts_product_alerts_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../product-alerts/product-alerts.component */ "./src/app/product-alerts/product-alerts.component.ts");
...
ProductListComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: ProductListComponent, selectors: [["app-product-list"]], decls: 3, vars: 1, consts: [[4, "ngFor", "ngForOf"], [3, "title"], [4, "ngIf"], [3, "click"], [3, "product", "something", "notify"]], template: function ProductListComponent_Template(rf, ctx) { if (rf & 1) {
...
module.exports = __webpack_require__(/*! E:\A_SELF IMPROUVING\DEVELOPMENT\Work with Father\1) Angular Project\Angular\Projects\Second\src\main.ts */"./src/main.ts");
